		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <?php for($i=0; $i<5; $i++){?>
                ...
                <div class="col-md-12"><label>Hình ảnh <?=$i+1?> </label></div>
                <div class="col-md-6"> <input type="file" name="file<?=$i?>" /> </div>
                <?
                ...
                <div class="col-md-6"><input type="text" name="ten<?=$i?>" id="ten<?=$i?>" value="" placeholder="<?=$ten?> " /></div>
                 <div class="col-md-12"><label>Số thứ tự</label></div>
                <div class="col-md-1">
                <input type="text" name="stt<?=$i?>" id="stt" value="<?=isset($item['stt'])?$item['stt']:1?>" placeholder="Số thứ tự" /></div>
     		<? }?>
