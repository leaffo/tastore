          ...
          <div class="inner">
                  ...
                  <tr>
                    ...
                    <td style=" width:20%;">
                        ...
                        <b class="cap3">Cấp 3: <?php
							$sql_danhmuc1="select ten from table_tin3cap_cat where id='".$v['id_cat2']."'";
							$result=mysql_query($sql_danhmuc1);
							$item_danhmuc1 =mysql_fetch_array($result);
							echo @$item_danhmuc1['ten'];
						?>
                    ...
                    <td style="width:76px;"><a href="index.php?com=tin3cap&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tin3cap.$v['photo']?>" border="1" class="sp_img" /></a></td> 
                                     
                    <td style="width:5%;"><a href="index.php?com=tin3cap&act=man_photo&id_cat=<?=$v['id']?>"><i class="fa fa-plus"></i> Add</a></td> 
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_right_10px">                  
                  <a href="index.php?com=tin3cap&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm tin tức</a>
