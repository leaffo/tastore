  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man1">Tin tức 1</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=tinnho&act=edit1&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten']?></a></td>
