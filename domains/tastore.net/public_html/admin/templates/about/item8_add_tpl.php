  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=about&act=capnhap8">Tuyển dụng</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=about&act=save8" enctype="multipart/form-data" class="basic-form inline-form">                              
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onClick="javascript:window.location='index.php?com=about&act=capnhap8'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
