  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=<?=$_GET['com']?>&act=man">Tin tức</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=<?=$_GET['com']?>&act=save_list<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">              
              ...
              <div class="col-md-12"><label>Nội dung </label></div>
               ...
               <?php */?>
                ...
                <div class="col-md-12 col-md-offset-1">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=<?=$_GET['com']?>&act=man_list<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
