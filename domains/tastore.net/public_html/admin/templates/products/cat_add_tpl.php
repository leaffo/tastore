		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=<?=$_GET['com']?>&act=save_cat<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">              
              <?php /*?>  <?php if ($_REQUEST['act']=='edit'){?>
                <div class="col-md-12"><label>Hình hiện tại</label></div>
                <div class="col-md-12"><img src="<?=_upload_tinnho.$item['photo']?>"  width="150" alt="NO PHOTO" /><br /><br /></div>
                <?php }?>
            ...
            <?php /*?>    <div class="col-md-12"><label>Mô tả </label></div>
                <div class="col-md-6"><textarea name="mota" cols="50" rows="5" id="mota" placeholder="Mô tả"><?=@$item['mota']?></textarea><br /></div>
                ...
                <div class="col-md-12 col-md-offset-1">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=<?=$_GET['com']?>&act=man_cat<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
