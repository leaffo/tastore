		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=tintuc&act=save<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">              
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=tintuc&act=man<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
